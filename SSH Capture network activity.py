...
def execute_program_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="execute program", parameters=parameters, assets=['ssh'], callback=Netstat_output, name="execute_program_1")

    return

def Netstat_output(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Netstat_output() called')
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="Netstat_output")
...
def add_note_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='Netstat_output')

    note_title = "Netstat output"
