...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched = phantom.decision(
        ...
        conditions=[
            ["url_reputation_1:action_result.data.*.positives", ">", 0],
            ["url_reputation_1:action_result.data.*.positives", "<", 5],
        ],
    ...
    matched = phantom.decision(
        ...
        conditions=[
            ["url_reputation_1:action_result.data.*.positives", ">=", 5],
            ["url_reputation_1:action_result.data.*.positives", "<", 15],
        ],
        logical_operator='and')
...
def Text_high_HUD(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    parameters = [
        "url_reputation_1:action_result.data.*.positives",
    ]
...
def url_reputation_1_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None):
    phantom.debug('url_reputation_1_callback() called')
    ...
    Summery_URL_reputation(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
...
def unshorten_url_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="unshorten url", parameters=parameters, assets=['phantom utilities'], callback=decision_4, name="unshorten_url_1")
...
def decision_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    join_url_reputation_1(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
...
def Summery_save_object(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='Summery_URL_reputation')
...
def decision_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched = phantom.decision(
        ...
        action_results=results,
        conditions=[
            ["unshorten_url_1:action_result.status", "!=", "Failed"],
        ])
